...
export function createTerrain(scene) {
  ...
  const uniforms = {
    uTime: { value: 0 },
    uProgress: { value: 0 },
    uSubsidenceDepth: { value: SimState.subsidenceDepth },
    uErosionIntensity: { value: SimState.erosionIntensity },
    uRidgeDensity: { value: SimState.ridgeDensity },
    uSedimentThickness: { value: SimState.sedimentThickness },
    uAridRate: { value: SimState.aridRate },
  };
  ...
  function update(time) {
    ...
    uniforms.uProgress.value = SimState.progress;
    uniforms.uSubsidenceDepth.value = SimState.subsidenceDepth;
    uniforms.uErosionIntensity.value = SimState.erosionIntensity;
    uniforms.uRidgeDensity.value = SimState.ridgeDensity;
    uniforms.uSedimentThickness.value = SimState.sedimentThickness;
    uniforms.uAridRate.value = SimState.aridRate;
  }
