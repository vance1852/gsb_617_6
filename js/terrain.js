...
// 顶点着色器：实现地壳下沉、沉积、干裂、风蚀五个阶段的地形形变
const vertexShader = `
        varying vec2 vUv;
        ...
        void main(){
          ...
          float crackStart = 0.45 / uAridRate;  // 干旱化速率越高，裂隙越早出现
          ...
          float crackWidth = 0.15 * uAridRate;  // 干旱化速率影响裂隙宽度
